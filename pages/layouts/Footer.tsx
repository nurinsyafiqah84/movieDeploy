...
const Footer = () => {
    return (
       <footer className="max-w-[1300px] mx-auto text-left p-8 text-white bg-darkBlue ">
            <div className="md:flex md:justify-center flex items-end mb-6 md:mb-10 max-w-[1300px] mx-auto">
                {/*untuk 3 column*/}
                <div className='mr-10'>
